<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="#">
      ...
      <span class="font-weight-bold text-white" style="font-size: 1.5em">DU 68 Market<img src="{{ asset('assets/img/icon1.png') }}" class="navbar-brand-img h-100" alt="main_logo"></span>
  ...
  <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      @endif
        ...
        @if ( auth()->user()->username == 'kasir') 
        <li class="nav-item">
          <a class="nav-link text-white {{ $activePage == 'laporan-kasir' ? 'active bg-gradient-primary' : '' }}" href="{{ route('kasir.laporan') }}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
